...
class FetchAndCarry(script):
	...
	def Initialize(self):
		...
		#kk_ handle_sdh = self.sss.move("sdh","home",False)
		...
		#kk_ retval = handle_sdh.get_error_code()
		#kk_ if retval > 0:
		#kk_	rospy.logerr("error in sdh, aborting...")
		#kk_	return False
	...
	def Run(self): 
		...
		#kk_ handle_sdh = self.sss.move("sdh","cylopen")
		...
		# grasp cup
		#kk_ self.sss.move("sdh","cylclosed")
		...
		self.sss.sleep(2)
		#kk_ self.sss.move("sdh","cylclosed",False)
		self.blink(handle01,"red")
		handle01.wait()
