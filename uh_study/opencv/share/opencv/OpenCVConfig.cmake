...
SET(OpenCV_INCLUDE_DIRS /tmp/buildd/ros-diamondback-vision-opencv-1.4.3/debian/ros-diamondback-vision-opencv/opt/ros/diamondback/stacks/vision_opencv/opencv2/opencv/include/opencv;/tmp/buildd/ros-diamondback-vision-opencv-1.4.3/debian/ros-diamondback-vision-opencv/opt/ros/diamondback/stacks/vision_opencv/opencv2/opencv/include)
...
SET(OpenCV_LIB_DIR /tmp/buildd/ros-diamondback-vision-opencv-1.4.3/debian/ros-diamondback-vision-opencv/opt/ros/diamondback/stacks/vision_opencv/opencv2/opencv/lib)
...
IF (NOT 1)
    ...
    LINK_DIRECTORIES(/tmp/buildd/ros-diamondback-vision-opencv-1.4.3/debian/ros-diamondback-vision-opencv/opt/ros/diamondback/stacks/vision_opencv/opencv2/opencv/lib/../3rdparty/lib)
    if(WIN32)
        LINK_DIRECTORIES(""/3rdparty/lib)
    else()
        LINK_DIRECTORIES(/tmp/buildd/ros-diamondback-vision-opencv-1.4.3/debian/ros-diamondback-vision-opencv/opt/ros/diamondback/stacks/vision_opencv/opencv2/opencv/lib/../share/opencv/3rdparty/lib)
    endif()    

	set(OpenCV_LIBS dl;m;pthread;rt  gtk-x11-2.0;gdk-x11-2.0;atk-1.0;pangoft2-1.0;gdk_pixbuf-2.0;m;pangocairo-1.0;cairo;gio-2.0;pango-1.0;freetype;fontconfig;gobject-2.0;gmodule-2.0;gthread-2.0;rt;glib-2.0;gthread-2.0;rt;glib-2.0 ${OpenCV_LIBS})
